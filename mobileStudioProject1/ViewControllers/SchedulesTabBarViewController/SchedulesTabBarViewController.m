...
- (void)viewDidLoad {
    ...
    [bikeShedules addObject: [[ScheduleItem alloc] initWithTitle:@"Научим трюкам" StartDate:startDate  Location:@"Адмиралтейская" Destination:@"Адмиралтейская" StartCoordinate:CLLocationCoordinate2DMake(59.93, 30.338) AndDestinationCoordinate:CLLocationCoordinate2DMake(59.943, 30.36) ]];
